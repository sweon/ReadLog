...
const translations: Translations = {
    ...
    search_placeholder: { en: 'Search books...', ko: '도서 검색...' },
    ...
    // Book Detail
    delete_book: { en: 'Delete Book', ko: '도서 삭제' },
    confirm_delete: { en: 'Are you sure you want to delete this book? This cannot be undone.', ko: '이 도서를 삭제하시겠습니까? 삭제된 데이터는 복구할 수 없습니다.' },
    ...
    select_book_prompt: { en: 'Select a book to view progress', ko: '도서를 선택하여 독서 진행 상황을 확인하세요' },
    start_prompt: { en: 'Or create a new one to get started.', ko: '또는 새 도서를 추가하여 시작해 보세요.' },
    congrats_finished: { en: 'Congratulations! You finished the book!', ko: '축하합니다! 책 한 권을 완독하셨네요!' },

    // Settings
    summary: { en: 'Summary', ko: '요약' },
    total_books: { en: 'Books', ko: '도서 수' },
    total_sessions: { en: 'Sessions', ko: '독서 세션' },
    data_management: { en: 'Data Management', ko: '데이터 관리' },
    backup_data: { en: 'Backup Data', ko: '데이터 백업' },
    backup_desc: { en: 'Export your reading logs to a JSON file. Select specific books or leave none selected to export everything.', ko: '독서 기록을 JSON 파일로 내보냅니다. 특정 도서만 선택하거나 전체를 백업할 수 있습니다.' },
    ...
    how_to_use_desc: { en: 'Add a new book using the "+ Add" button in the sidebar. Track your daily progress by entering the current page number on the book\'s detail page. Use the sync feature to view your progress on multiple devices.', ko: '사이드바의 "+ 추가" 버튼으로 새 도서를 등록하세요. 도서 상세 페이지에서 매일 읽은 페이지 수를 입력해 진도를 기록할 수 있습니다. 동기화 기능을 통해 여러 기기에서 기록을 확인하세요.' },
    app_info: { en: 'App Information', ko: '앱 정보' },
    app_info_desc: { en: 'ReadLog v1.2.0 - A local-first, privacy-focused reading tracker.', ko: 'ReadLog v1.2.0 - 개인정보를 보호하는 로컬 기반 독서 추적기.' },
    ...
    new_books: { en: 'New Books', ko: '새 도서' },
