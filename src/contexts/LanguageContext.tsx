...
const translations: Translations = {
    ...
    sync_room_id: { en: 'Room ID', ko: '룸 ID' },
    sync_passcode: { en: 'Passcode (PIN)', ko: '비밀번호 (PIN)' },
    sync_how_to_host: { en: 'Enter the Room ID and Passcode shown here into your other device to start syncing.', ko: '여기에 표시된 룸 ID와 비밀번호를 다른 기기에 입력하면 동기화가 시작됩니다.' },
    sync_how_to_join: { en: 'Enter the Room ID and Passcode shown on the sending device.', ko: '보내는 기기의 화면에 표시된 룸 ID와 비밀번호를 입력하세요.' },
    sync_send_response: { en: 'Send my library back to other device', ko: '내 서재 데이터를 상대 기기로도 보내기' },
    sync_response_code: { en: 'Response Code', ko: '회신 코드' },
    sync_waiting_response: { en: 'Waiting for response from other device...', ko: '상대 기기의 회신을 기다리는 중...' },
    sync_starting: { en: 'Starting sync...', ko: '동기화 시작 중...' },
    sync_connecting: { en: 'Connecting to other device...', ko: '상대 기기와 연결 중...' },
    sync_sending_response: { en: 'Sending merged library back...', ko: '이미 데이터가 합쳐진 서재를 회신하는 중...' },
    sync_fully_complete: { en: 'Sync Fully Complete! Both devices are now identical.', ko: '동기화 완료! 이제 양쪽 기기 모두 동일한 서재를 공유합니다.' },
    ...
    factory_reset: { en: 'Factory Reset', ko: '초기화' },
    factory_reset_desc: { en: 'Delete all books and reading logs. This action cannot be undone.', ko: '모든 책과 독서 기록을 삭제합니다. 이 작업은 되돌릴 수 없습니다.' },
    factory_reset_confirm: { en: 'Are you sure you want to delete ALL data? This will permanently remove all books and logs.', ko: '정말로 모든 데이터를 삭제하시겠습니까? 모든 책과 기록이 영구적으로 제거됩니다.' },
    factory_reset_warning: { en: 'Warning: This will wipe your entire library.', ko: '경고: 서재의 모든 데이터가 삭제됩니다.' },
    factory_reset_button: { en: 'Reset All Data', ko: '모든 데이터 지우기' },
    reset_success: { en: 'All data has been cleared.', ko: '모든 데이터가 삭제되었습니다.' },
};
